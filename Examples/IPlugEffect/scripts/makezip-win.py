...
def main():
  ...
  if not zip:
    ...
    files = [
      projectpath + "\\build-win\IPlugEffect.vst3\Contents\\x86_64-win\IPlugEffect.vst3",
      projectpath + "\\build-win\IPlugEffect_x64.exe"  
    ]
  ...
  files = [
    projectpath + "\\build-win\\pdbs\\IPlugEffect-vst3_x64.pdb",
    projectpath + "\\build-win\\pdbs\\IPlugEffect-app_x64.pdb"  
  ]
